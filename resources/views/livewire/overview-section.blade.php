                ...
                <div class="mx-auto max-w-2xl">
                    <div class="max-w-lg">
                        ...
                        <div class="mt-24 sm:mt-32 lg:mt-16">
                            <a href="{{ route('events.incoming') }}" class="inline-flex space-x-6">
                                <span class="rounded-full bg-indigo-600/10 px-3 py-1 text-sm font-semibold leading-6 text-indigo-600 ring-1 ring-inset ring-indigo-600/10">Prochain event</span>
                                <span class="inline-flex items-center space-x-2 text-sm font-medium leading-6 text-gray-600">
                                    <span>Du 11 au 13 octobre 2024</span>
                        ...
                        <h1 class="mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                            L'Évènement caritatif queer
                        </h1>
                        <p class="mt-6 text-lg leading-8 text-gray-600">
                            Le prochain évènement caritatif queer aura lieu du 11 au 13 octobre 2024 au profit de l'association Un Abri Qui Sauve Des Vies.
                        </p>
                        <div class="mt-10 flex items-center gap-x-6">
                            ...
                            <a href="#" class="text-sm font-semibold leading-6 text-gray-900">L'association <span aria-hidden="true">→</span></a>
                        </div>
                    </div>
                </div>
            </div>
